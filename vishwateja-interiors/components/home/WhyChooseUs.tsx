...
const points = [
  { title: "Modern Machinery", desc: "Automated, precision-driven manufacturing — not just manual carpentry." },
  { title: "Exact Measurements", desc: "Machine-cut precision means perfect fits, every single time." },
  { title: "Premium Materials", desc: "Quality plywood, laminates, and hardware sourced for durability." },
  { title: "On-Time Delivery", desc: "Structured production process means no unpredictable delays." },
];
