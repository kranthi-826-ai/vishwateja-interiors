      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
        {services.map((s, i) => (
          <Reveal key={s.name} delay={i * 80}>
            <div className="group border border-graylight rounded-2xl p-6 hover:border-royal hover:shadow-xl hover:-translate-y-2 active:scale-95 transition-all duration-300 cursor-pointer">
