...
export default function InvoicePage() {
  ...
  return (
    <section className="max-w-4xl mx-auto px-6 py-16 print:py-0">
      <div className="flex justify-between items-start mb-10 print:mb-6">
        ...
        <div className="text-right">
          ...
          <input
            ...
            className="text-sm text-navy/70 border-none text-right print:hidden"
          />
        </div>
      </div>
      ...
      <button onClick={addRow} className="text-royal text-sm font-medium mb-10 print:hidden">
        + Add Row
      </button>
      ...
      <div className="flex justify-end mb-10">
        <div className="w-full sm:w-72 space-y-2 text-sm">
          ...
          <div className="flex justify-between bg-navy text-white px-4 py-3 rounded-lg font-semibold mt-3">
      ...
      <p className="text-xs text-navy/50 mb-6">
        Thank you for choosing Vishwateja Interiors. Payment due within 7 days.
        Warranty terms apply as per agreement.
      </p>
      ...
      <div className="flex flex-wrap gap-4 print:hidden">
        ...
        <button
          ...
          className="bg-navy text-white px-6 py-3 rounded-full font-medium hover:bg-royal transition-colors duration-300"
        >
          Print / Save PDF
        </button>
        <a
          href={`https://wa.me/91${customer.mobile}?text=Hi ${customer.name}, here is your invoice ${invoiceNumber} — Grand Total ₹${grandTotal.toLocaleString("en-IN")}`}
          target="_blank"
          className="border border-navy text-navy px-6 py-3 rounded-full font-medium hover:bg-navy hover:text-white transition-colors duration-300"
        >
          Send via WhatsApp
        </a>
      </div>
